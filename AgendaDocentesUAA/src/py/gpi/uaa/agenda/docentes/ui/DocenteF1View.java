...
public class DocenteF1View {
	...
	private void initialize() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\MANUAL\\Docente.jpg"));
		label.setBounds(60, 35, 691, 466);
		AyudaDocente.getContentPane().add(label);
		AyudaDocente.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\agenda_android.png"));
