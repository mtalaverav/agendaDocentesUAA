...
public class AgendaView {
	...
	private void initialize() {
		...
		frmAgendaDeDocentes.setIconImage(Toolkit.getDefaultToolkit()
				.getImage("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\agenda_android.png"));
		...
		label.setIcon(new ImageIcon("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\agenda.png"));
		label.setBounds(85, 337, 194, 164);
		frmAgendaDeDocentes.getContentPane().add(label);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\logo2.png"));
		lblNewLabel.setBounds(300, 32, 171, 188);
		frmAgendaDeDocentes.getContentPane().add(lblNewLabel);
		
		JLabel label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\pikachu.png"));
		...
		ayudaAgenda.setIcon(new ImageIcon("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\ayuda.png"));
