...
public class AgendaF1View {
	...
	private void initialize() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\MANUAL\\Agenda de docentes.jpg"));
		label.setBounds(65, 26, 701, 499);
		frameAyudaAgenda.getContentPane().add(label);
		frameAyudaAgenda.setTitle("Ayuda - Agenda");
		frameAyudaAgenda.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Melissa\\workspace\\AgendaDocentesUAA\\agenda_android.png"));
