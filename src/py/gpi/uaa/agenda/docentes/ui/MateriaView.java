...
public class MateriaView {
	...
	private void initialize() {
		...
		frameMateria.setIconImage(Toolkit.getDefaultToolkit().getImage("agenda_android.png"));
		...
		lblNewLabel.setIcon(new ImageIcon("materia.png"));
		...
		labelAyuda.setIcon(new ImageIcon("ayuda.png"));
